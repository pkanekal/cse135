...
try
{
	...
	<form action="salesanalytics2.jsp" method="post">
		...
		<br>
		<% //if(!(action.equals("Next10Products")) || !(action.equals("Next20Rows"))) %>
		<p> </p><b>Filters:</b>
		<div id="filter">
			State: 
			<select name="state">
			...
			<br>
			Age:
			<% //if (!offsetVar.equals("0")) { System.out.println("delete filter"); }
			//else {%>
			<select name="age">
				<option value="All">All</option>
...
if (stateRow){
	...
	%>
	<div align="left"><form action="salesanalytics2.jsp" method="get" value="Next20Rows">
